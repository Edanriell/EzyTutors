...
grant all privileges on table ezy_tutor to truuser;
grant all privileges on table ezy_course to truuser;
grant all privileges on all sequences in schema public to truuser;
/* grant all privileges on sequence ezy_tutor_tutor_id_seq1; */

SELECT setval('ezy_course_course_id_seq', 1);
SELECT setval('ezy_tutor_tutor_id_seq', 1);
...
SELECT setval('ezy_tutor_tutor_id_seq', (SELECT MAX(tutor_id) FROM ezy_tutor)+1);
SELECT setval('ezy_course_course_id_seq', (SELECT MAX(course_id) FROM ezy_course)+1);
